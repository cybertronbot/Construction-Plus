  ...
  return (
    <div className="bg-[#161616] ">
      <div className="flex justify-center items-center flex-col ">
        <div className="flex justify-center items-start md:flex-row flex-col w-full  sm:px-20 px-5 pt-16 pr-[300px]">
          <div className="flex-1 flex flex-col justify-start mr-10">
            ...
            <p className="font-poppins font-medium  text-white text-sm mt-3 sm:max-w-[410px]">
              <span>Telephone: </span>+234 905 6161 616
            </p>
          </div>
          <ul className="flex-[1.5] w-full flex flex-row justify-between flex-wrap ">
            {footerLinks.map((footerLink, index) => (
              <li className="flex flex-col  min-w-[150px]" key={index}>
                ...
                <ul className="mt-4">
                  {footerLink.links.map((link, index) => {
                    return (
                      <li
                        className="font-poppins font-medium text-[16px] text-white max-w-[310px] "
                        key={index}
                      >
                        {link.name}
                      </li>
      ...
      <ul className="flex gap-3 justify-end px-32">
